...
resource "aws_ec2_transit_gateway_vpc_attachment" "security-app-tgw-security-vpc" {
  subnet_ids                                      = [aws_subnet.sec_subnet_peering_region-az-1.id, aws_subnet.sec_subnet_peering_region-az-2.id]
  transit_gateway_id                              = aws_ec2_transit_gateway.security-app-tgw.id
  ...
  tags = {
    Name = "${var.project}_security-app-tgw-security-vpc"
  }
}
...
resource "aws_ec2_transit_gateway_route_table_association" "security-app-tgw-security-vpc-internal" {
  transit_gateway_attachment_id  = aws_ec2_transit_gateway_vpc_attachment.security-app-tgw-security-vpc.id
